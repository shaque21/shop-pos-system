                            ...
                            @foreach ($users as $key=>$item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="text-danger mx-1" href="{{ url('/admin/restore/users/delete/'.$item->slug) }}"><i class="fas fa-trash fa-lg" data-toggle="tooltip" data-placement="top" title="Delete Task"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
